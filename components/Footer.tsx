    ...
    <footer className="bg-gray-900 text-gray-100">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-lg font-bold text-white mb-4">Nashville Cleaning Directory</h3>
            <p className="text-sm text-gray-400 mb-4">
              Your trusted resource for finding vetted cleaning services in Nashville and surrounding areas.
            </p>
            <div className="space-y-2">
              <div className="flex items-start gap-2">
                <MapPin size={16} className="flex-shrink-0 mt-0.5" />
                <p className="text-sm text-gray-400">Nashville, Tennessee</p>
              </div>
              <div className="flex items-start gap-2">
                <Phone size={16} className="flex-shrink-0 mt-0.5" />
                <a href="tel:+1-615-000-0000" className="text-sm text-gray-400 hover:text-white transition">
                  +1 (615) 000-0000
                </a>
              </div>
              <div className="flex items-start gap-2">
                <Mail size={16} className="flex-shrink-0 mt-0.5" />
                <a href="mailto:info@nashvillecleaningdirectory.com" className="text-sm text-gray-400 hover:text-white transition">
                  info@nashvillecleaningdirectory.com
                </a>
              </div>
            </div>
          </div>
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-6xl mx-auto px-4 py-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-500 mb-4 md:mb-0">
            &copy; {currentYear} Nashville Cleaning Directory. All rights reserved.
          </p>
